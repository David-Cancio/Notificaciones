            ...
            <table Class="tabla">
                <tr>
                    <td colspan="2">Nombre del Estado:
                            <input type="text" name="prm_estado_nombre" size="40" required pattern="[A-ZÑ,Á,É,Í,Ó,Ú]{1}[a-zA-Z\sñ,á,é,í,ó,ú,ü]{1,}" title="Indique el Nombre del Estado" value="<%response.write(estado("Prm_Estado_Nombre"))%>"/>
                    </td>
                </tr>
            </table>
            <div class="container">
